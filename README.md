...
Welcome to my portfolio website! This website showcases my skillsSection, projects, and experience. The website is built using React and Next.js, providing a smooth and responsive user experience. The entire website is designed as a single-page application, resembling a one-page resume.

You can access the website <a href="https://kianattar.com">here</a>.
...
- Build the site with `pnpm pages:build` (this outputs `out/`), then preview or deploy using `pnpm pages:preview` or `pnpm pages:deploy`.
- The site is fully static; the contact form is intentionally disabled and there are no API routes.
